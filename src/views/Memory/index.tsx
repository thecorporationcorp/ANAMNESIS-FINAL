  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        />
        <motion.div
          className="absolute top-1/2 right-1/4 w-80 h-80 rounded-full bg-gradient-to-br from-violet-500/8 to-purple-500/8 blur-3xl"
          animate={{
            x: [0, -80, 0],
            y: [0, 60, 0],
            scale: [1, 1.15, 1],
        ...
        />
        <motion.div
          className="absolute bottom-1/3 left-1/2 w-72 h-72 rounded-full bg-gradient-to-br from-pink-500/6 to-orange-500/6 blur-3xl"
          animate={{
            x: [0, 50, 0],
            y: [0, -30, 0],
            scale: [1, 1.1, 1],
      ...
      <motion.button
        ...
        className="fixed top-6 right-6 z-50 w-10 h-10 rounded-lg bg-black/40 backdrop-blur-md border border-cyan-400/30 hover:border-cyan-400/60 hover:bg-cyan-500/10 transition-all duration-300 flex items-center justify-center group"
      >
      ...
      >
        {/* Header */}
        <div className="flex-none px-12 pt-20 pb-6">
          <motion.h1
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.3 }}
            className="text-4xl md:text-6xl font-light text-cyan-300 mb-6 tracking-tight leading-tight drop-shadow-[0_0_12px_rgba(34,211,238,0.5)]"
          >
            {memory.title}
          </motion.h1>
